...
export const INITIAL_PROFILE: Profile = {
  name: '전혜미 (Haemi Jeon)',
  alias: '해몽가 (Haemongga)',
  role: '3D Generalist & Concept-driven Motion Designer',
  email: 'contact@haemongga.com',
  behance: 'https://www.behance.net/haemongga',
  notefolio: 'https://notefolio.net/haemongga',
